    ...
    return (
        <div className="container mx-2 p-3 pt-16">
            <div className="max-w-full">
                <h2 className="text-lg w-fit lg:mx-5 font-semibold border-b-2 border-red-600 ">Concept</h2>
            </div>

            <div className="max-w-full flex flex-wrap lg:mx-5">
                <div className="max-w-sm mr-5 max-h-72 mt-2 md:mx-2  overflow-hidden">
